...
### - URLs and Links
gitgub_url = 'https://www.google.com/'
discord_url = 'https://www.discord.gg/'
reset_password_url = 'https://www.google.com/'
...
attackers_delight = os.path.join(themes_path, "attackers_delight.json")  # Red colored theme :shrug:
